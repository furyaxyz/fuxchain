...
contract Exchange is ERC20 {
    ...
    string public wasmContractAddress = "did:fury:ex14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s6fqu27";

    event __FURYCSendToWasm(string wasmAddr, string recipient, uint256 amount);
    ...
    function send_to_wasm(string memory recipient,string memory wasmContract , uint256 amount) public {
        ...
        emit __FURYCSendToWasm(wasmContract,recipient, amount);
    }
}
