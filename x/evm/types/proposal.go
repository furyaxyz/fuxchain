...
// FixShortAddr is to fix the short address problem in the FURYC test-net.
// The normal len(BlockedContract.Address) should be 20,
// but there are some BlockedContract.Address in FURYC test-net that have a length of 4.
