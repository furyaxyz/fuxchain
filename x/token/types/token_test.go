...
func TestToken(t *testing.T) {
	...
	testCase := []struct {
		...
		{Token{
			Description:         "furylockchain coin",
			Symbol:              common.NativeToken,
			OriginalSymbol:      common.NativeToken,
			WholeName:           "ok coin",
			...
			Owner:               addr,
			Mintable:            true,
		}, `{"description":"furylockchain coin","symbol":"` + common.NativeToken + `","original_symbol":"` + common.NativeToken + `","whole_name":"ok coin","original_total_supply":"1000000000.000000000000000000","type":0,"owner":"did:fury:ex1jedas2n0pq2c68pelztgel8ht8pz50rh7s7vfz","mintable":true}`},
	}
