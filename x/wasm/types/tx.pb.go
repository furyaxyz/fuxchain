...
type MsgExecuteContract struct {
	...
	Funds github_com_cosmos_cosmos_sdk_types.CoinAdapters `protobuf:"bytes,5,rep,name=funds,proto3,castrepeated=github.com/furyaxyz/fuxchain/libs/cosmos-sdk/types.Coins" json:"funds"`
}
