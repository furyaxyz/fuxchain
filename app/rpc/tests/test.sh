...
fuxchaind add-genesis-account $(fuxchaincli keys show $KEY1 -a --home $HOME_CLI) 1000000000okb --home $HOME_SERVER
fuxchaind add-genesis-account $(fuxchaincli keys show $KEY2 -a --home $HOME_CLI) 1000000000okb --home $HOME_SERVER
