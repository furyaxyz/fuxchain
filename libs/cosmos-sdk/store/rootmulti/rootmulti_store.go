...
import (
	...
	"github.com/furyaxyz/fuxchain/libs/cosmos-sdk/store/cachemulti"
...
func (rs *Store) loadVersion(ver int64, upgrades *types.StoreUpgrades) error {
	...
	if len(rs.pruneHeights) > maxPruneHeightsLength {
		return fmt.Errorf("Pruned heights length <%d> exceeds <%d>, "+
			...
			"<fuxchaind data prune-compact all --home your_fuxchaind_home_directory> before running fuxchaind",
