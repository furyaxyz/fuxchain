...
import (
	...
	srvconfig "github.com/furyaxyz/fuxchain/libs/cosmos-sdk/server/config"
...
func TestnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for an FURYChain testnet",
		Long: `testnet will create "v" number of directories and populate each with
necessary files (private validator, genesis, config, etc.).

Note, strict routability for addresses is turned off in the config file.`,

		Example: "fuxchaind testnet --v 4 --keyring-backend test --output-dir ./output --starting-ip-address 192.168.10.2",
	...
	cmd.Flags().String(flagNodeDaemonHome, "fuxchaind", "Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "fuxchaincli", "Home directory of the node's cli configuration")
...
func InitTestnet(
	...
	if chainID == "" {
		chainID = fmt.Sprintf("fuxchain-%d", tmrand.Int63n(9999999999999)+1)
	}
