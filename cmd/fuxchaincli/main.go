...
import (
	...
	"github.com/furyaxyz/fuxchain/app/codec"
	"github.com/furyaxyz/fuxchain/app/crypto/ethsecp256k1"
	chain "github.com/furyaxyz/fuxchain/app/types"
	"github.com/furyaxyz/fuxchain/cmd/client"
	sdkclient "github.com/furyaxyz/fuxchain/libs/cosmos-sdk/client"
	...
	clientrpc "github.com/furyaxyz/fuxchain/libs/cosmos-sdk/client/rpc"
	sdkcodec "github.com/furyaxyz/fuxchain/libs/cosmos-sdk/codec"
	...
	authcmd "github.com/furyaxyz/fuxchain/libs/cosmos-sdk/x/auth/client/cli"
	...
	tokencmd "github.com/furyaxyz/fuxchain/x/token/client/cli"
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "fuxchaincli",
		Short: "Command line interface for interacting with fuxchaind",
	}
	...
	// Add flags and prefix all env exposed with FUXCHAIN
