...
fuxchaincli tx wasm execute "$contractAddr" '{"transfer":{"amount":"100","recipient":"did:fury:ex1eutyuqqase3eyvwe92caw8dcx5ly8s544q3hmq"}}' --fees 0.001fury --from captain -b block -y
...
echo "#### smart state"
fuxchaincli query wasm contract-state smart "$contractAddr" '{"balance":{"address":"did:fury:ex1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v"}}'
fuxchaincli query wasm contract-state smart "$contractAddr" '{"balance":{"address":"did:fury:ex1eutyuqqase3eyvwe92caw8dcx5ly8s544q3hmq"}}'
