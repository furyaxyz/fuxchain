...
res=$(fuxchaincli tx wasm instantiate "$code_id" '{"decimals":10,"initial_balances":[{"address":"0x21e283524309CD7eC9B789B43F073e93e43e1B8f","amount":"100000000"}],"name":"clockend network token", "symbol":"XFURY"}' --label test1 --admin did:fury:ex1h0j8x0v9hs4eq6ppgamemfyu4vuvp2sl0q9p3v --fees 0.001fury --from captain -b block -y)
